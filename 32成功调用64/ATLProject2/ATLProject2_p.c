...
#define TYPE_FORMAT_STRING_SIZE   1169                              
...
#pragma code_seg(".orpc")
static const FormatInfoRef IDMessage_Ndr64ProcTable[] =
    {
...
static const MIDL_SYNTAX_INFO IDMessage_SyntaxInfo [  2 ] = 
    {
    {
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    0,
    ...
    0,
    0 ,
    (unsigned short *) &IDMessage_Ndr64ProcTable[-3],
    0,
...
static const MIDL_STUBLESS_PROXY_INFO IDMessage_ProxyInfo =
    ...
    2,
    (MIDL_SYNTAX_INFO*)IDMessage_SyntaxInfo
...
static const MIDL_SERVER_INFO IDMessage_ServerInfo = 
    ...
    0,
    ATLProject2__MIDL_ProcFormatString.Format,
    (unsigned short *) &IDMessage_FormatStringOffsetTable[-3],
    0,
